...
class Aluno : public Pessoa {
 ...
 public:
  ...
  // O construtor deve chamar o construtor de Pessoa para os atributos n (nome)
  // e i (idade) O construtor cópia de Aluno deve chamar o construtor cópia de
  // Pessoa
  ...
  // Getters e Setters
  // Eles serão definidos aqui para os atributos de Aluno, que herda nome e
  // idade de Pessoa
